        ...
        <div id="resume" className="min-h-screen relative overflow-hidden noise-texture" style={{backgroundColor: '#F9EFE7'}}>
            ...
            <div className="relative z-10 min-h-screen flex flex-col lg:flex-row about-page">
                ...
                <div className="flex-1 px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-16 lg:py-20 relative scroll-animate-left">                                        
                    ...
                    <div className="max-w-2xl ml-0 sm:ml-8 md:ml-12 lg:ml-20">
                        {/* Resume title */}
                        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-8 md:mb-16" style={{color: '#5A4636'}}>Resume.</h1>
                        
                        {/* Education Section */}
                        <div className="mb-4 sm:mb-6 md:mb-12 scroll-animate-scale">
                            <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4 md:mb-6" style={{color: '#5A4636'}}>Education</h2>
                            <div className="space-y-3 sm:space-y-4">
                                <div className="flex items-start hover-lift smooth-transition">
                                    <div className="w-2 h-2 rounded-full mt-2 mr-3 flex-shrink-0 animate-pulse-subtle" style={{backgroundColor: '#5A4636'}}></div>
                                    <div>
                        ...
                        {/* Skills Section */}
                        <div className="mb-4 sm:mb-6 md:mb-12 scroll-animate-scale">
                            <h2 className="text-lg sm:text-xl font-bold mb-2 sm:mb-4 md:mb-6" style={{color: '#5A4636'}}>Skills</h2>
            ...
            <div className="flex-1 px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-16 lg:py-20 scroll-animate-right">
                <div className="max-w-2xl">
                    {/* Projects Section */}
                    <div>
                            <h1 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6" style={{color: '#5A4636'}}>Projects</h1>
                        <div className="space-y-12 sm:space-y-5 md:space-y-6 stagger-animate">
                            {/* SwiftCart Project */}
                            <div className="hover-lift smooth-transition">
                                <h3 className="font-bold text-sm sm:text-base" style={{color: '#5A4636'}}>SWIFTCART</h3>
                            ...
                            {/* NotifyX Project */}
                            <div className="hover-lift smooth-transition">
                                <h3 className="font-bold text-sm sm:text-base" style={{color: '#5A4636'}}>NOTIFYX</h3>
                            ...
                            {/* FailForward Project */}
                            <div className="hover-lift smooth-transition">
                                <h3 className="font-bold text-sm sm:text-base" style={{color: '#5A4636'}}>FAILFORWARD</h3>
                                <p className="text-xs sm:text-sm italic mb-2" style={{color: '#3C3C3C'}}>Productivity Platform | Mar 2025 - Apr 2025</p>
                                <p className="text-xs sm:text-sm mb-2" style={{color: '#3C3C3C'}}>Technologies: Java, Spring Boot, PostgreSQL, REST APIs, Clerk, React.js, Vercel Deployment</p>
                                <ul className="text-xs sm:text-sm space-y-1" style={{color: '#3C3C3C'}}>
                                    <li>• Developed and deployed backend REST APIs with secure authentication</li>
                                    <li>• Implemented role-based workflows and access control systems</li>
                                    <li>• Optimized SQL queries and schema design for high-volume user data</li>
                                    <li>• Collaborated with frontend engineers for seamless cross-team integration</li>
                                </ul>
                            </div>
                        </div>
                    </div>
